...
<section id="product-categories"
  ...
  $x = 1;
    ...
    $button_label = get_term_meta($category->term_id, 'button_label', true);
		?>
    <div class="container-fluid px-0 d-flex cover category-item test" >
      <div class="container-fluid px-0 d-flex">
        ...
        d-flex w-100 align-items-center">
          ...
          <div class="col-lg-6 col-sm-6 col-sm-12 col-12 col-content category-item-content" style="text-align:center"> 
						<h3 class="font-weight-bold macSizee"><?php echo $category->name; ?></h3>
            <div class="category-item-description macDes mb-3">
